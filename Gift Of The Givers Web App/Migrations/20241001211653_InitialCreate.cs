    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IncidentReport", x => x.ReliefProjectID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReliefProject", x => x.ReliefProjectID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolunteerRegistration", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Donation_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserContributions", x => x.ContributionID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VolunteerRegistrationUserID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contributions", x => x.ContributionID);
                    table.ForeignKey(
                        name: "FK_Contributions_VolunteerRegistration_VolunteerRegistrationUserID",
                        column: x => x.VolunteerRegistrationUserID,
                        principalTable: "VolunteerRegistration",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Contributions_VolunteerTasks_TaskID",
                        column: x => x.TaskID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolunteerTaskAssignments", x => x.AssignmentID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resources_Donation_DonationID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contributions_VolunteerRegistrationUserID",
                table: "Contributions",
                column: "VolunteerRegistrationUserID");

            migrationBuilder.CreateIndex(
                name: "IX_Donation_UsersId",
                table: "Donation",
                column: "UsersId");

            migrationBuilder.CreateIndex(
                name: "IX_Resources_DonationID",
                table: "Resources",
                column: "DonationID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VolunteerTaskAssignments_TaskID",
